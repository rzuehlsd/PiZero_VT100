...
| 4 | Press `Ctrl-C` in host mode. | Session exits host mode and returns to log/command prompt. | PASS / FAIL / N/A |
| 5 | Optional: send `+++` in host mode. | Fallback escape exits host mode reliably. | PASS / FAIL / N/A |
